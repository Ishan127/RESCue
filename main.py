...
train_loader = DataLoader(train_ds, batch_size=32, shuffle=True, collate_fn=grefcoco_collate_fn, num_workers=2)
val_loader = DataLoader(val_ds, batch_size=32, shuffle=False, collate_fn=grefcoco_collate_fn, num_workers=2)
